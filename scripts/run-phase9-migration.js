...
async function runMigration() {
  ...
  try {
    console.log('🔄 Iniciando migration FASE 9...\n');
    
    // Ler o arquivo SQL
    const migrationPath = path.join(__dirname, 'migrate-phase9-alerts.sql');
    ...
    console.log('\n✅ Migration FASE 9 executada com sucesso!\n');
    ...
    const enumCheck = await client.query(`
      ...
      WHERE typname IN ('AlertType', 'AlertSeverity')
      ORDER BY typname
    `);
